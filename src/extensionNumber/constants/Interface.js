export default {
    ...
    sellerAndAE: {
        ...
        getUserInfo:'/cross/getUserLoginInfo', //获取用户信息,
        getSimilarAccount: '/extentionAccount/getSimilarAccount',//选择相似账号弹框提交	
        postSimilarAccount: '/extentionAccount/similarAccount'//获取相似账号	
    },
    media: {
